"""
Django settings for Ami_hybrid_ToT project.
...
SECRET_KEY = 'django-insecure-82@wka-l08t*(-z65w&=1e7529--9ff1h%4q$*#um)*$uexx%t'
...
ROOT_URLCONF = 'Ami_hybrid_ToT.urls'
...
WSGI_APPLICATION = 'Ami_hybrid_ToT.wsgi.application'
